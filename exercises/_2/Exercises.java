...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        for (int i = 0; i < studentAges.size(); i++) {
            ...
            Student students1 = new Student(studentNames.get(i), studentAges.get(i));
            System.out.println("Student name is: " + students1.name + ", student age is: " + students1.age);
        }
        System.out.println("Constructed"); //Non sono riuscito a mettere Constructing e Constructed nel costruttore
    }
